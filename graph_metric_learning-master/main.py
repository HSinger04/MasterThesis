...
data_folder = "data/ntu/one_shot/"

data = read_pkl(filename=data_folder+"train_label.pkl")
print(data)

datanp = np.load(data_folder+"train_data_joint.npy")
print(data)
...
def init_seed(_):
    # TODO: @Raphael: What exactly are the seeds for?
...
class Processor():
    """ 
        Processor for Skeleton-based Action Recognition. Handles the whole pipeline based on the given args.
    """
    ...
    def load_model(self):
        ...
        if type(self.arg.device) is list:
            if len(self.arg.device) > 1:
                # TODO: @Raphael: Why did he use nn.DataParallel
    ...
    def start(self):
        if self.arg.phase == 'train':
            ...
            # TODO: Specifies for how long they train. Replace with "while" and a function that specifies the termination condition
...
# TODO: Confirm with Raphael: Doesn't get used, right? And as such, also never "start"
